...
<head>
  <meta charset="utf-8">
  <title>Academics Hours and Programmes</title>
  ...
  <div id="wrapper">
          ...
          <div class="span12">
            <div class="inner-heading">
              <ul class="breadcrumb">
                ...
                <li class="active">Academics Hours and Programmes</li>
              </ul>
              <h2>Academics Hours and Programmes</h2>
            </div>
          </div>
        </div>
      </div>
    ...
    <?php
           ...
           include_once './Class/Database_class.php';
                    ...
                    $result = $databaseClass->select_all_academic_programf();  
