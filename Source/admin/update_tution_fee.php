...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        if ($fileNameUrl != '') {
            $admin_object->update_tution_fee($fileNameUrl);
            ?>
            <div class="box-header well" data-original-title>
...
//$row = mysqli_fetch_array($res);
        ...
        <div class="box-content">
            ...
            <form class="form-horizontal" action="index.php?id=update_tution_fee"  method="post"  enctype="multipart/form-data" onsubmit="return validateStandard(this)">
                <fieldset>
                    <legend></legend>
           ...
           include_once './admin_class.php';
                    $admin_object = new admin_class();
                    $result = $admin_object->select_all_tution_fee();  
