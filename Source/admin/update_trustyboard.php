<div class="box-content">
    ...
    <ul class="breadcrumb">
        ...
        <li>
            <a href="#"> Update Board Of Trusty</a>
        </li>
    </ul>
</div>
...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        if ($fileNameUrl != '') {
            $admin_object->add_trustyboard($fileNameUrl,$name,$designation,$mobile,$email,$sequence);
...
//$row = mysqli_fetch_array($res);
        ...
        <div class="box-content">
            ...
            <form class="form-horizontal" action="index.php?id=update_trustyboard"  method="post"  enctype="multipart/form-data" onsubmit="return validateStandard(this)">
                <fieldset>
                    <legend></legend>
    ...
    <tbody>
          ...
          <?php
           ...
           include_once './admin_class.php';
                    $admin_object = new admin_class();
                    $result = $admin_object->select_all_trustyboard();  
        ...
        <td class="center"><?php echo $row['sequence']; ?></td>
         ...
         <td class="center">
             ...
             <a class="btn btn-danger" href="index.php?id=update_trustyboard&delect_member=<?php echo $row['id'];?> " title="Delete" onclick=" return confirm_delete('Are you sure you want to delete this item?');">
