...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        if ($fileNameUrl != '') {
            $admin_object->add_student_pdf($fileNameUrl,$pdf_title,$class);
            ?>
            <div class="box-header well" data-original-title>
...
//$row = mysqli_fetch_array($res);
        ...
        <div class="box-content">
            ...
            <form class="form-horizontal" action="index.php?id=student_info"  method="post"  enctype="multipart/form-data" onsubmit="return validateStandard(this)">
                <fieldset>
                    <legend></legend>
    ...
    <tbody>
          ...
          <?php
           ...
           include_once './admin_class.php';
                    $admin_object = new admin_class();
                    $result = $admin_object->select_all_student_pdf();  
        ...
        <td class="center"><?php echo $row['class']; ?></td>
         ...
         <td class="center">
             ...
             <a class="btn btn-danger" href="index.php?id=student_info&delete_student_pdf=<?php echo $row['id'];?> " title="Delete" onclick=" return confirm_delete('Are you sure you want to delete this item?');">
