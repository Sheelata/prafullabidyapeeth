...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        if ($fileNameUrl != '') {
            $admin_object->add_chairman_image($fileNameUrl);
            ?>
            <div class="box-header well" data-original-title>
...
//$row = mysqli_fetch_array($res);
        ...
        <div class="box-content">
            ...
            <form class="form-horizontal" action="index.php?id=chairman_info"  method="post"  enctype="multipart/form-data" onsubmit="return validateStandard(this)">
                <fieldset>
                    <legend></legend>
            ...
            <div id="photodiv">
                <ul>
                    ...
                    $res = $admin_object->get_chairman_image();
...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        $chairman_message_1stPart = filter_input(INPUT_POST, 'chairman_message_1stPart');
        $chairman_message_2ndPart = filter_input(INPUT_POST, 'chairman_message_2ndPart');
        

        
      

        if ($chairman_message_1stPart != NULL && $chairman_message_2ndPart != NULL ) {
            $admin_object->update_chairman_info($chairman_message_1stPart,$chairman_message_2ndPart);
...
$res = $admin_object->get_chairman_info();
        $row = mysqli_fetch_array($res);
?>
        <div class="box-content">
            <h3>          
            ...
            <form class="form-horizontal" action="index.php?id=chairman_info"  method="post" onsubmit="return validateStandard(this)">
                <fieldset>
                    <legend></legend>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                          <textarea name="chairman_message_1stPart" style="width: 100%;">
                                        <?php echo $row['chairman_message_1stPart'];;  ?>
                          </textarea>
                        </div>
                    </div> 
                           <div class="control-group">
                        ...
                        <div class="controls">
                          <textarea name="chairman_message_2ndPart" style="width: 100%;">
                                        <?php echo $row['chairman_message_2ndPart'];  ?>
                          </textarea>
                        </div>
                    </div> 
