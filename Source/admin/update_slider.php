...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        unlink($link);
            $admin_object->delete_slider_image($imageId);
            ?>
            <div class="box-header well" data-original-title>
        ...
        if ($fileNameUrl != '') {
            $admin_object->add_slider_image($fileNameUrl, $description);
            ?>
            <div class="box-header well" data-original-title>
...
//$row = mysqli_fetch_array($res);
        ...
        <div class="box-content">
            ...
            <form class="form-horizontal" action="index.php?id=update_slider"  method="post"  enctype="multipart/form-data" onsubmit="return validateStandard(this)">
                <fieldset>
                    <legend></legend>
            ...
            <div id="photodiv">
                <ul>
                    ...
                    include_once './admin_class.php';
                    $admin_object = new admin_class();
                    $res = $admin_object->get_all_slider_image();
                    while ($row = mysqli_fetch_assoc($res)) {
                        ?> 

                        <li style="background-image: url('<?php echo $row['image_link']; ?>');" class="aimg"><a class="ajax-link" onclick="return confirm('Are you sure you want to delete this item?')" href="index.php?id=update_slider&imageId=<?php echo $row['id']; ?> &link=<?php echo $row['image_link']; ?> "> <span>DELETE</span> </a></li>
