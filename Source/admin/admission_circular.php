<div class="box-content">
    ...
    <ul class="breadcrumb">
        ...
        <li>
            <a href="#"> Update Admission Circular</a>
        </li>
    </ul>
</div>
...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        if ($fileNameUrl != '') {
            $admin_object->update_admission_circular($fileNameUrl);
            ?>
            <div class="box-header well" data-original-title>
...
//$row = mysqli_fetch_array($res);
        ...
        <div class="box-content">
            ...
            <form class="form-horizontal" action="index.php?id=admission_circular"  method="post"  enctype="multipart/form-data" onsubmit="return validateStandard(this)">
                <fieldset>
                    <legend></legend>
           ...
           include_once './admin_class.php';
                    $admin_object = new admin_class();
                    $result = $admin_object->select_admission_circular();  
